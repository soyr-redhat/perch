...
`src/perch/` contains the application package, including desktop lifecycle code and static assets. `tests/` contains unit, runtime, and fixture-harness tests. `packaging/` contains PyInstaller and platform installer definitions; `scripts/` contains validation and benchmark helpers.
...
ruff check .
node --check src/perch/static/app.js
