...
Plugins can contain platform-specific code, commands, environment assumptions, and approval rules. Copying their installation directories across harnesses is not a supported interchange format. Perch shares explicit skills and MCP configuration, reports unsupported mappings, and offers a reviewed context handoff. Hooks and agent definitions require harness-specific conversion before they can be considered portable.
